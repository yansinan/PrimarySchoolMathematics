...
**新文档**：[_ARCHIEVED_06-PLAN-v2-ability-analysis.md](_ARCHIEVED_06-PLAN-v2-ability-analysis.md)（v2.0，2026-06-05）
...
### 错题计数规则 — 详细设计见 [_ARCHIEVED_06-PLAN-v2-ability-analysis.md](_ARCHIEVED_06-PLAN-v2-ability-analysis.md)
- 本次**只打数据 + 服务基础**，不实现 1-strike
- 字段定义、迁移策略、扩展点在独立文档

### 弱项判定 v2 — 详细设计见 [_ARCHIEVED_06-PLAN-v2-ability-analysis.md](_ARCHIEVED_06-PLAN-v2-ability-analysis.md)
...
- **[_ARCHIEVED_06-PLAN-v2-ability-analysis.md](_ARCHIEVED_06-PLAN-v2-ability-analysis.md)** — P2 细化（能力分析与错题强化，数据 + 服务层）
