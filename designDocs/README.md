...
**下一目标**（[05-PLAN-v3-architecture-tuning.md § 12](./_ARCHIVED_05-PLAN-v3-architecture-tuning.md) 完整规划）：
...
**v3 调优计划完整版**（archived）：[_ARCHIVED_05-PLAN-v3-architecture-tuning.md](./_ARCHIVED_05-PLAN-v3-architecture-tuning.md)
...
│
└── _ARCHIVED_*.md                         已落地计划 / 报告 / smoke test（不读）
    ├── _ARCHIVED_02-PROGRESS.md          v3 收尾前的逐行 commit 日志
    ├── _ARCHIVED_04-PLAN-v2-architecture-refactor.md   v2.3 7 阶段计划（已落地）
    ├── _ARCHIVED_05-PLAN-v3-architecture-tuning.md    v3 8 大组计划（已落地）
    ├── _ARCHIVED_06-PLAN-v2-ability-analysis.md       P2 阶段（已落地）
    ├── _ARCHIVED_08-PLAN-v2-自适应出题.md              暂缓
    ├── _ARCHIVED_11-PLAN-browser-smoke-test.md        smoke test 计划（旧）
    ├── _ARCHIVED_12-TODO-browser-smoke-test-v2.3.md   smoke test 清单（12/12 通过）
    └── _ARCHIVED_13-SMOKE-TEST-REPORT-v2.3.md         smoke test 报告
```
...
[README]  ← 当前在哪步（入口索引）
       ...
       │         │
       │         └──→ [_ARCHIVED_02-PROGRESS]  逐行 commit 日志
       │         └──→ [_ARCHIVED_04/05/06-PLAN-*]  已落地的计划
       │
       └──→ [_ARCHIVED_05-PLAN-v3]          v3 调优 8 大组（含 § 12 下阶段规划）
                │
                ├──→ [_ARCHIVED_12-TODO-browser-smoke-test]  smoke 清单
                └──→ [_ARCHIVED_13-...-report]              smoke 报告
```
...
- **`_ARCHIVED_XX-NAME.md`** — 已落地 / 历史（不读，仅保留备查）
...
| 怎么把代码迁成目标态 | [_ARCHIVED_04-PLAN-v2-architecture-refactor.md](./_ARCHIVED_04-PLAN-v2-architecture-refactor.md) |
| 怎么清死代码 / 调优 | [_ARCHIVED_05-PLAN-v3-architecture-tuning.md](./_ARCHIVED_05-PLAN-v3-architecture-tuning.md) |
| 产品设计 | [DESIGN.md](./DESIGN.md) |
| P2 阶段细节 | [_ARCHIVED_06-PLAN-v2-ability-analysis.md](./_ARCHIVED_06-PLAN-v2-ability-analysis.md) |
| UI 规划 | [07-PLAN-v2-ui-roadmap.md](./07-PLAN-v2-ui-roadmap.md) |
| 出题流程业务 | [DESIGN.md](./DESIGN.md) |
| 浏览器实测细节 | [_ARCHIVED_12-TODO-browser-smoke-test-v2.3.md](./_ARCHIVED_12-TODO-browser-smoke-test-v2.3.md) |
