...
- P2 体系: [_ARCHIVED_06-PLAN-v2-ability-analysis.md](./_ARCHIVED_06-PLAN-v2-ability-analysis.md)
- P0-P4 路线: [03-PLAN-v2-roadmap.md](./03-PLAN-v2-roadmap.md)
- 实施过程: [IMPLEMENTATION_HISTORY.md](./IMPLEMENTATION_HISTORY.md)
- v3 调优计划（已落地）: [_ARCHIVED_05-PLAN-v3-architecture-tuning.md](./_ARCHIVED_05-PLAN-v3-architecture-tuning.md)
